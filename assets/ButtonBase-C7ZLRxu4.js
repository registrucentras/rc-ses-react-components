...
`;function Ze(o){if(o.motion.reducedMotion==="always")return null;const e=ie`
  ...
  `;return o.motion.reducedMotion==="system"?ie`
    ...
    `:e}const et=ne("span",{name:"MuiTouchRipple",slot:"Root"})({overflow:"hidden",pointerEvents:"none",position:"absolute",zIndex:0,top:0,right:0,bottom:0,left:0,borderRadius:"inherit"}),tt=ne(Xe,{name:"MuiTouchRipple",slot:"Ripple"})`
  opacity: 0;
  position: absolute;
