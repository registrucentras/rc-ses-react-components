...
function G1() {
  return or || (or = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function I(c) {
      return !!(typeof c == "string" || typeof c == "function" || c === n || c === o || W || c === i || c === d || c === f || L || c === m || R || y || x || typeof c == "object" && c !== null && (c.$$typeof === p || c.$$typeof === g || c.$$typeof === s || c.$$typeof === l || c.$$typeof === u || // This needs to include all possible module reference object
      ...
      children: [
        /* @__PURE__ */ a.jsx(
          C1,
          {
            ...
            expandIcon: u === !1 ? null : /* @__PURE__ */ a.jsx(mn, {}),
            children: g
          }
        ),
...
var li = { parse: function(t, e) {
  ...
  return t.replace(oi, function(u, d) {
    ...
    if (g && (o++, (r = sr(u)).type === "tag" && e.components[r.name] && (r.type = "component", s = !0), r.voidElement || s || !v || v === "<" || r.children.push({ type: "text", content: t.slice(m, t.indexOf("<", m)) }), o === 0 && n.push(r), (f = i[o - 1]) && f.children.push(r), i[o] = r), (!g || r.voidElement) && (o > -1 && (r.voidElement || r.name === u.slice(2, -1)) && (o--, r = o === -1 ? n : i[o]), !s && v !== "<" && v)) {
...
const mi = (t) => {
  ...
  if (e === "") return [];
  const s = n.transKeepBasicHtmlNodesFor || [], l = e && new RegExp(s.map((k) => `<${k}`).join("|")).test(e);
  if (!t && !l && !o) return [e];
  const u = {}, d = (k) => {
    ke(k).forEach((b) => {
      re(b) || (mt(b) ? d(Ct(b)) : Se(b) && !Qe(b) && Object.assign(u, b));
    });
  };
  d(t);
    ...
    return ke(j).reduce((y, x, L) => {
      ...
      if (x.type === "tag") {
        ...
        const I = Object.keys(x.attrs).length !== 0 ? xi({
          props: x.attrs
        }, $) : $, U = Qe(I), ee = U && mt(x, !0) && !x.voidElement, H = l && Se(I) && I.dummy && !U, z = Se(t) && Object.hasOwnProperty.call(t, x.name);
        if (re(I)) {
...
function yi(t) {
  ...
  const E = vn(e, j), R = u || E || j.transEmptyNodeValue || i, {
    hashTransKey: y
  } = j, x = i || (y ? y(E || R) : E || R);
...
const ki = (t, e) => {
  ...
  const f = (o.isInitialized || o.initializedStoreOnce) && d.every((R) => ci(R, o, s)), g = ji(o, e.lng || null, s.nsMode === "fallback" ? d : d[0], u), p = () => g, m = () => Sn(o, e.lng || null, s.nsMode === "fallback" ? d : d[0], u), [v, w] = h1(p);
  let k = d.join();
  e.lng && (k = `${e.lng}${k}`);
  const j = ki(k), b = on(!0);
  Xe(() => {
    ...
    b.current = !0, !f && !l && (e.lng ? ur(o, e.lng, d, () => {
      b.current && w(m);
    }) : lr(o, d, () => {
      b.current && w(m);
...
class hr extends ot {
  ...
  addResourceBundle(e, r, n, i, o) {
    ...
    s.skipCopy || (n = JSON.parse(JSON.stringify(n))), i ? kn(u, n, o) : u = {
      ...u,
      ...n
...
class it extends ot {
  ...
  translate(e, r, n) {
    ...
    if (b && p && (typeof p != "string" && typeof p != "boolean" && typeof p != "number") && k.indexOf(w) < 0 && !(typeof j == "string" && Array.isArray(p))) {
      ...
      if (y || R || z) {
        if (this.logger.log(z ? "updateKey" : "missingKey", d, u, s, z ? U : p), o) {
  ...
  extendTranslation(e, r, n, i, o) {
    ...
    return e != null && u && u.length && n.applyPostProcessor !== !1 && (e = jn.handle(u, e, r, this.options && this.options.postProcessPassResolved ? {
      i18nResolved: {
        ...i,
  ...
  resolve(e) {
    ...
    return typeof e == "string" && (e = [e]), e.forEach((u) => {
      ...
      g.forEach((k) => {
        this.isValidLookup(n) || (l = k, !gr[`${w[0]}-${k}`] && this.utils && this.utils.hasLoadedNamespace && !this.utils.hasLoadedNamespace(l) && (gr[`${w[0]}-${k}`] = !0, this.logger.warn(`key "${i}" for languages "${w.join(", ")}" won't get resolved as namespace "${l}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), w.forEach((j) => {
          if (this.isValidLookup(n)) return;
          s = j;
          const b = [f];
  ...
  interpolate(e, r, n, i) {
    ...
    const u = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, d = (m) => {
      if (m.indexOf(this.formatSeparator) < 0) {
        const j = xr(r, u, m, this.options.keySeparator, this.options.ignoreJSONStructure);
      ...
      return this.format(xr(r, u, w, this.options.keySeparator, this.options.ignoreJSONStructure), k, n, {
        ...i,
        ...r,
        interpolationkey: w
      });
...
function Nr(t, e = {}) {
  ...
  if (s) {
    ...
    if (n.timeZone || e.timeZone) {
      if (d = On(n.timeZone || e.timeZone, new Date(l + u)), isNaN(d))
        return /* @__PURE__ */ new Date(NaN);
    } else
...
function Ys(t) {
  const { actions: e, onAccept: r, onCancel: n, onClear: i, onSetToday: o, ...s } = t, l = F1();
...
function Zs(t) {
  ...
  return /* @__PURE__ */ a.jsxs(Ks, { children: [
    ...
    /* @__PURE__ */ a.jsxs(Rt, { direction: "row", children: [
      /* @__PURE__ */ a.jsx(Je, { onClick: l, title: s == null ? void 0 : s.nextMonth, children: /* @__PURE__ */ a.jsx(ti, {}) }),
      /* @__PURE__ */ a.jsx(Je, { onClick: u, title: e("nextYear"), children: /* @__PURE__ */ a.jsx(Q1, {}) })
    ] })
  ] });
}
const t0 = A.forwardRef((t, e) => {
  var b, E, R, y, x, L, W, $;
  const { t: r } = ie("input", { keyPrefix: "components.RcSesDatepicker" }), n = an(Le.breakpoints.up("md")), { id: i, clearable: o, errors: s, label: l, slotProps: u, ...d } = t, f = A.useContext(dn), {
        ...
        $1,
        {
          ...
          slotProps: {
            ...
            inputAdornment: {
              position: "start",
              sx: { mr: "0 !important" },
              ...((x = (y = u == null ? void 0 : u.datepicker) == null ? void 0 : y.slotProps) == null ? void 0 : x.inputAdornment) ?? {}
            },
            textField: {
              id: v,
              error: !!s,
              ...
              ...((W = (L = u == null ? void 0 : u.datepicker) == null ? void 0 : L.slotProps) == null ? void 0 : W.textField) ?? {}
            },
            toolbar: { hidden: !0 }
          },
          value: w,
      ...
      Pt,
      {
        ...
        InputProps: {
          startAdornment: /* @__PURE__ */ a.jsxs($e, { alignItems: "center", direction: "row", children: [
            ...
            /* @__PURE__ */ a.jsx(Fe, { position: "start", children: /* @__PURE__ */ a.jsx(fe, { color: h.grey[900], component: "span", children: l.code }) })
          ] })
        },
        inputProps: {
          id: r,
            ...
            Pt,
            {
              ...
              InputProps: {
                ...
                endAdornment: /* @__PURE__ */ a.jsxs(a.Fragment, { children: [
                  l ? /* @__PURE__ */ a.jsx(P1, { color: "inherit", size: 16 }) : null,
