...
export declare const Main: AnnotatedStoryFn<ReactRenderer, Pick<{
    ...
    onChange?: ((event: React.SyntheticEvent, value: NonNullable<"" | {
        description?: string;
        label: string;
        value: string;
    ...
    renderOption?: ((props: React.HTMLAttributes<HTMLLIElement> & {
        ...
        label: string;
        value: string;
    }, false, boolean, false, "div">) => React.ReactNode) | undefined;
    renderTags?: ((value: ("" | {
        description?: string;
        label: string;
        value: string;
    ...
    onHighlightChange?: ((event: React.SyntheticEvent, option: "" | {
        description?: string;
        label: string;
        value: string;
