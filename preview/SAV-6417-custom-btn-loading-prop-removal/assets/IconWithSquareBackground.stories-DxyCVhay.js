import{I as i,j as n}from"./iframe-CW-h-lR4.js";import{R as c}from"./index-DHH2s2tQ.js";import{S as a}from"./Stack-BuYFTjqP.js";import{T as e}from"./Typography-bOKMNxZ6.js";import"./preload-helper-PPVm8Dsz.js";import"./resolvePaletteColorPath-CFWn7ipM.js";import"./Box-QFZvygG7.js";import"./generateUtilityClasses-DGi4yQgU.js";import"./memoTheme-BKfEdFx3.js";import"./useThemeProps-CnvbWpDc.js";import"./getThemeProps-BksAypjP.js";import"./createSimplePaletteValueFilter-bm0fmN_7.js";const z={title:"Atoms/IconWithSquareBackground",component:c,tags:["autodocs"],argTypes:{size:{control:{type:"select"},options:[40,44]},variant:{control:{type:"select"},options:["solid","soft","muted"]}}},r={args:{Icon:i,size:44,variant:"solid"}},p=[40,44],m=["solid","soft","muted"],t={parameters:{controls:{disable:!0}},render:()=>n.jsx(a,{spacing:3,children:p.map(s=>n.jsxs(a,{spacing:1,children:[n.jsxs(e,{variant:"caption",children:["size: ",s]}),n.jsx(a,{direction:"row",spacing:2,sx:{alignItems:"center"},children:m.map(o=>n.jsxs(a,{spacing:.5,sx:{alignItems:"center"},children:[n.jsx(c,{Icon:i,size:s,variant:o}),n.jsx(e,{variant:"caption",children:o})]},o))})]},s))})};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
    Icon: InfoFillIcon,
    size: 44,
    variant: 'solid'
...
//# sourceMappingURL=IconWithSquareBackground.stories-DxyCVhay.js.map
