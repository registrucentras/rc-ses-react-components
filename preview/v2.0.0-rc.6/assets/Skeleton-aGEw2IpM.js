import{r as C,h as b,j as w,f as k,y as h,x as m}from"./iframe-CDc5tlXL.js";import{c as S,m as x}from"./memoTheme-DMsyr4pX.js";import{c as u}from"./utils-cxgvJEOf.js";import{g as R,a as M}from"./generateUtilityClasses-DGi4yQgU.js";import{s as $}from"./styled-DCBzl_Uz.js";function U(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function A(t){return parseFloat(t)}function X(t){return R("MuiSkeleton",t)}M("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const j=t=>{const{classes:e,variant:a,animation:s,hasChildren:o,width:n,height:i}=t;return S({root:["root",a,s,o&&"withChildren",o&&!n&&"fitContent",o&&!i&&"heightAuto"]},X,e)},r=m`
  0% {
    opacity: 1;
  }
...
//# sourceMappingURL=Skeleton-aGEw2IpM.js.map
